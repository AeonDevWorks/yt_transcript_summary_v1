...
function injectReactComponent() {
  ...
  if (targetElement) {
    ...
    if (window.trustedTypes && trustedTypes.createPolicy) {
      const policy = trustedTypes.createPolicy('react-html', {
      ...
      ReactDOM.render(React.createElement(TranscriptDisplay), container);
    }
  }
}
...
async function fetchAndParseCaptions(captionTrackUrl) {
